...
- [Chainlink](https://chain.link/) - Αποτελεί ένα από τα πιο γνωστά πρωτόκολλα για τη διασύνδεση του υπόλοιπου κόσμου με το Web 3.0 (και το Blockchain κατ'επέκταση) με τη δημιουργία και υποστήριξη μηχανισμών oracle. (**_Βαθμός 5_**)
