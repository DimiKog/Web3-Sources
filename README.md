...
- [Patrick Collins Mega Course](https://www.youtube.com/watch?v=gyMwXuJrbJQ&ab_channel=freeCodeCamp.org) - 31 ώρες εκπαιδευτικού υλικού που θεωρείται classic για την εισαγωγή σας στον κόσμο του Blockchain και του Web 3.0 (**_Βαθμός 5_**)
...
- [Chainlink](https://chain.link/](https://docs.chain.link/) - Αποτελεί ένα από τα πιο γνωστά πρωτόκολλα για τη διασύνδεση του υπόλοιπου κόσμου με το Web 3.0 (και το Blockchain κατ'επέκταση) με τη δημιουργία και υποστήριξη μηχανισμών oracle. (**_Βαθμός 5_**)
